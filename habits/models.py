...
class Habit(models.Model):
    ...
    def clean(self):
        # Валидация: нельзя выбирать одновременно вознаграждение и связанную привычку
        if self.reward and self.linked_habit:
            raise ValidationError('Можно заполнить либо вознаграждение, либо связанную привычку, но не оба поля одновременно.')
